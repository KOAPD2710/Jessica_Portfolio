                ...
                {data.show_final_design && (
                    <Fragment>
                        <div className="proj-dtl-body-final_design-label-wrapper proj-dtl-body-label-wrapper">
                            ...
                            <div className="proj-dtl-body-final_design-sub proj-dtl-body-sub txt">{data.sub_final_design[0]?.text}</div>
                        </div>
                ...
                {data.show_takeaway && (
                    <Fragment>
                        <div className="proj-dtl-body-takeaway-label-wrapper proj-dtl-body-label-wrapper">
                            ...
                            <div className="proj-dtl-body-takeaway-sub proj-dtl-body-sub txt">{data.sub_takeaway[0]?.text}</div>
                        </div>
